...
# Utils
from deepSurv_utils import reproducibility, path_config, prepare_data, data_to_gpu, grid_searches, cross_validate
...
def main():
    ...
    for dataset_file in datasets:
        ...
        X_train_folds = [X_gpu[train_idx] for train_idx, _ in fold_indexes]
        X_val_folds   = [X_gpu[val_idx]   for _, val_idx   in fold_indexes]
