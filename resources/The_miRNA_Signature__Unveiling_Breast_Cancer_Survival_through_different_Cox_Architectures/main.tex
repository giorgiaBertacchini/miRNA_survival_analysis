...
\section{Results}
    ...
    From our analysis the "age at initial diagnosis" is consistently at the top for the PCA+DeepSurv architecture, while in the non-linear one, it has impact only for the mRNA datasets. Other clinical data is nearly completely absent and it could be due to 3 main factors:\begin{itemize}
